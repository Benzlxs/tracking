...
from utils.geometric_util import Rz as geo_Rz, angle_of_2lines, OBJ_DEF
...
def corners4_to_mesh2(corners, color=[255,0,0]):
  ...
  mesh.vertices = open3d.Vector3dVector(corners)
...
class Bbox3D():
  ...
  def draw_lines_open3d(lines, color=[0,0,0], show=False):
    ...
    line_set.points = open3d.Vector3dVector(lines)
