...
class ClustersFiltering(object):
    ...
    def __init__(self, config):
        ...
        #     "filtering_with_all": self.filtering_with_all, # xyz(size), merge, z(height), filtering_with_num_points
        #     "filtering_wiht_xyz": self.filtering_with_xyz,
        #     "filtering_wiht_xyz_merge": self.filtering_with_xyz_merge,
        #     "filtering_wiht_xyz_merge_z": self.filtering_with_xyz_merge_z,
        #     "filtering_wiht_xyz_z": self.filtering_with_xyz_z,
        #     "filtering_wiht_xyz_merge_numpoints": self.filtering_with_xyz_merge_numpoints,
        #     "filtering_wiht_xyz_z_numpoints": self.filtering_with_xyz_z_numpoints,
        #     "filtering_wiht_merge_numpoints": self.filtering_with_merge,
        #     "filtering_wiht_": self.filtering_with_merge,
        # }
        ...
        _teniques_names = self.clusterfiltering_method.split('_')
    ...
    def filtering_clusters(self, clusters):
        ...
        if self.xyzsize:
            s_clusters, mm_xyz = filtering_with_xyz_jit(s_clusters, self.max_length_cluster, self.max_width_cluster)
        else:
